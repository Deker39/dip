...
print (
    "                   "+colors.B+"/"+colors.W+"  \,---,/  "+colors.B+"\\"+colors.W+"                                   ")#                   /  \,---,/  \
print (
    "                   "+colors.B+"\\"+colors.W+"___TTTTT___"+colors.B+"/"+colors.W+"         CODE: MIRROR  ")#                   \___TTTTT___/
...
print ("        "+Information.Type+"    "+colors.R+"|"+colors.W+"  I_"+colors.R+"|"+colors.W+"GOLENKO"+colors.R+"|"+colors.W+"_I  "+colors.R+"|"+colors.W+"                               ")#                "+colors.R+"|"+colors.W+"  I_"+colors.R+"|"+colors.W+".ANATAK"+colors.R+"|"+colors.W+"_I  "+colors.R+"|"+colors.W+"
...
print ("     ^ ^ ^ ^   ,ww   "+colors.O+".PROJECT."+colors.W+"   ww,                                 ")#     ^ ^ ^ ^ EHT KROWEMARF, dliuB
